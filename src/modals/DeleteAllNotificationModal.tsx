...
const DeleteAllNotificationModal = ({ onClose, setNotifications }: DeleteNotificationModalProps) => {
  ...
  return (
    <Modal title='Delete notifications' content='Are you sure you want to delete all notifications?' onClose={onClose} onConfirm={clickHandler} loading={loading} confirmText='Confirm' successMessage={successMessage} errorMessage={errorMessage} />
  )
}
