...
const AdminUsers = () => {
  ...
  const [selectedItemUser, setSelectedItemUser] = useState<MongoDbUser | null>(null);
  ...
  return (
    <>
      <AuthenticatedTemplate>
        {
          role !== "admin" && !loadingUser ? <Unauthorized /> :
            <div className="adminGeneral-container">
              ...
              />
              {popUpEditModal && <EditUserAdminModal onClose={setPopUpEditModal} userEdit={selectedItemUser} />}
              {popUpDeleteModal && <DeleteUserAdminModal onClose={setPopUpDeleteModal} userIdToDelete={selectedItemUser?._id || ''} />}
              <AdminTable list={currentUsers as MongoDbUser[]} setSelectedUser={setSelectedItemUser} setPopupEditUser={setPopUpEditModal} setPopupDeleteUser={setPopUpDeleteModal}  />
