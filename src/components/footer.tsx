    ...
    <footer>
      <div className="topPart">
        <div className="footer_img">
          <a href="/" className="desk-foot-img">
        ...
        <div className="footer__socials">
          <a className="footer-round" href="https://www.linkedin.com/company/brightest-nv/" target="_blank">
            <FaLinkedin />
          </a>
          <a className="footer-round" href="https://www.facebook.com/BrightestNV/" target="_blank">
            <FaFacebook />
          </a>
          <a className="footer-round" href="https://www.instagram.com/brightestsoftwarequality/" target="_blank">
            <FaInstagram />
          </a>
        </div>
      </div>
