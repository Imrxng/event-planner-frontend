...
import { Event, MongoDbUser, Notification, Poll } from '../../types/types';
...
interface PaginationProps {
    ...
    itemsList: Event[]|Poll[]|MongoDbUser[]|Notification[]|undefined;
    itemsPerPage: number;
    currentPage: number;
    pagesPerGroup: number;
}

const Pagination = ({ setCurrentPage, itemsList, itemsPerPage, currentPage , pagesPerGroup}: PaginationProps) => {
    const totalPages = itemsList
        ...
        <div className="pagination">
            ...
            {Array.from({ length: endPage - startPage + 1 }, (_, index) => (
                <button
                    ...
                    className={`numbers-button ${currentPage === startPage + index ? "current-page" : ""
                        }`}
                >
                    {startPage + index}
                </button>
